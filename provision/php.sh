...
sudo apt-get install -qq apache2 php8.1 php8.1-curl php8.1-tidy php8.1-gd php8.1-imagick php8.1-xml php8.1-xmlrpc php8.1-intl php8.1-cli php-pear php8.1-dev php8.1-ldap libapache2-mod-php8.1 php-codesniffer php8.1-mbstring php8.1-pgsql php8.1-mysql php8.1-gettext php8.1-zip php8.1-soap php8.1-tokenizer &> /dev/null
