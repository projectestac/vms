...
sudo apt-get install -qq apache2 libapache2-mod-xsendfile php7.4 php7.4-curl php7.4-tidy php7.4-gd php7.4-xml php7.4-xmlrpc php7.4-intl php7.4-cli php-pear php7.4-dev php7.4-ldap libapache2-mod-php7.4 php-codesniffer php7.4-mbstring php7.4-pgsql php7.4-mysql php7.4-gettext php7.4-zip php7.4-soap php-sodium php7.4-tokenizer php7.4-imagick &> /dev/null

sudo mkdir /etc/apache2/ioc
sudo cp -R /vms/provision/conf/* /etc/apache2/ioc

echo "Include ioc/" | sudo tee -a /etc/apache2/apache2.conf
...
sudo ln -s /etc/apache2/ioc/moodle.conf /etc/apache2/sites-enabled/moodle.conf
...
#echo "xdebug.mode=debug" | sudo tee -a /etc/php/7.4/apache2/conf.d/20-xdebug.ini
#echo "xdebug.idekey=\"vagrant\"" | sudo tee -a /etc/php/7.4/apache2/conf.d/20-xdebug.ini
#echo "xdebug.cli_color=0" | sudo tee -a /etc/php/7.4/apache2/conf.d/20-xdebug.ini
