...
sudo apt-get install -qq apache2 php8.3 php8.3-curl php8.3-tidy php8.3-gd php8.3-imagick php8.3-xml php8.3-intl \
                         php8.3-cli php-pear php8.3-dev libapache2-mod-php8.3 php-codesniffer php8.3-mbstring php8.3-pgsql \
                         php8.3-mysql php8.3-gettext php8.3-zip php8.3-soap php8.3-tokenizer &> /dev/null

# Ensure PHP 8.3 is the version used.
...
#echo "xdebug.mode=debug" | sudo tee -a /etc/php/8.3/apache2/conf.d/20-xdebug.ini
#echo "xdebug.idekey=\"vagrant\"" | sudo tee -a /etc/php/8.3/apache2/conf.d/20-xdebug.ini
#echo "xdebug.cli_color=0" | sudo tee -a /etc/php/8.3/apache2/conf.d/20-xdebug.ini
#echo "xdebug.start_with_request=no" | sudo tee -a /etc/php/8.3/apache2/conf.d/20-xdebug.ini
#echo "xdebug.client_port=9003" | sudo tee -a /etc/php/8.3/apache2/conf.d/20-xdebug.ini
#echo "xdebug.client_host=10.0.2.15 " | sudo tee -a /etc/php/8.3/apache2/conf.d/20-xdebug.ini
