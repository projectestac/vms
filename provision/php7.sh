...
sudo apt-get install -qq apache2 libapache2-mod-xsendfile php7.4 php7.4-curl php7.4-tidy php7.4-gd php7.4-xml php7.4-xmlrpc php7.4-intl php7.4-cli php-pear php7.4-dev php7.4-ldap libapache2-mod-php7.4 php-codesniffer php7.4-mbstring php7.4-pgsql php7.4-mysql php-gettext php7.4-zip php7.4-soap php-sodium php7.4-tokenizer php7.4-imagick &> /dev/null
...
sudo sed -i "s/post_max_size = .*/post_max_size = 200M/" /etc/php/7.4/apache2/php.ini
