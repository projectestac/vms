...
sudo apt-get install -qq apache2 php7.4 libapache2-mod-php7.4 php7.4-xml php7.4-cli php7.4-mbstring php7.4-mysql php7.4-tokenizer php7.4-zip php7.4-curl &> /dev/null
...
sudo sed -i "s/max_input_vars = .*/max_input_vars = 2000/" /etc/php/7.4/cli/php.ini
