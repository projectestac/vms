...
psql -U postgres -h localhost -c "CREATE DATABASE $usu LC_COLLATE ='ca_ES.UTF-8' LC_CTYPE = 'ca_ES.UTF-8' TEMPLATE template0;" &> /dev/null
psql -U postgres -h localhost -d $usu -1 -f /vms/agora/usu1-moodle.sql &> /dev/null
